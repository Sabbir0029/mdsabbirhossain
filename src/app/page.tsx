      ...
      <div className="px-6 lg:px-12 py-12 lg:py-20">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center max-w-7xl mx-auto">
          ...
          >
            ...
            >
              <p className="text-xl lg:text-2xl font-medium mb-4">Hello, It is Me</p>
              <h1 className="text-4xl lg:text-4xl xl:text-5xl font-bold mb-4 leading-tight">MD. SABBIR HOSSAIN</h1>
              <p className="text-xl lg:text-2xl font-medium">
                And I am a <span className="text-cyan-400 font-bold">Software Engineer</span>
              </p>
            </motion.div>

            <motion.p
              className="text-gray-300 text-base lg:text-lg leading-relaxed max-w-md"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
